...
const sync_cron_1 = require("./sync.cron");
const sgp_module_1 = require("../sgp/sgp.module");
...
exports.SyncModule = SyncModule = __decorate([
    (0, common_1.Module)({
        imports: [sgp_module_1.SgpModule, billing_module_1.BillingModule],
        controllers: [sync_controller_1.SyncController],
        providers: [sync_service_1.SyncService, sync_cron_1.SyncCron],
